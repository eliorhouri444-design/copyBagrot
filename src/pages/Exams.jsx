...
import { BookOpen, CheckCircle, Award, Clock, Play, Crown, X, Upload, Settings, Trophy, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, Accessibility, Shield, TrendingDown, Lock, Target, TrendingUp, Edit2, Trash2, Loader2, BookCheck, FileCheck, Save, FileText } from "lucide-react";
    ...
    <div className="bg-indigo-50 pb-4 min-h-screen">
      ...
      <Dialog open={!!showAttemptDetails} onOpenChange={() => {setShowAttemptDetails(null);}}>
        <DialogContent dir="rtl" className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <DialogFooter>
            <Button onClick={() => setShowAttemptDetails(null)} className="bg-blue-500 text-[#ffffff] px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-blue-700 h-9 w-full">
              סגור
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        <DialogContent dir="rtl" className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <DialogFooter className="mt-4 flex flex-col sm:flex-row-reverse sm:space-x-2 space-y-2 sm:space-y-0">
            ...
            <Button
              ...
              className="bg-blue-500 text-white px-4 py-2 text-sm font-medium rounded-md whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm h-9 w-full sm:w-auto hover:bg-blue-700 flex items-center justify-center gap-2">
