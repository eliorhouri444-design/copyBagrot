...
import { 
  BookOpen, ChevronLeft, Loader2, Check, Lock, Crown
} from 'lucide-react';
...
export default function GrammarTopicsSelectionPage() {
      ...
      <div className="bg-blue-600 px-5 py-4 rounded-b-2xl">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center flex-1">
            <h1 className="text-lg font-bold text-white">בחירת נושא</h1>
            <p className="text-xs text-white/80">דקדוק • Grammar</p>
          </div>
              ...
              <motion.button
                ...
                onClick={() => {
                  if (isLocked) {
                    ...
                    navigate(createPageUrl(`GrammarPracticeNew?topic=${topic.id}&mode=practice`));
                  }
                }}
