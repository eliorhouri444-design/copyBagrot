          ...
          <div className="bg-[#ffffff] p-6 rounded-t-3xl from-orange-50 to-red-50 border-b-2 border-blue-500">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                <div className="text-[#080707] text-sm font-medium">
                  שאלה {question.question_number} - טעית בה במבחן
                </div>
                <div className="text-[#030303] text-xs font-bold">
                  הזדמנות לתקן!
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-50 p-4 rounded-xl border-2 border-blue-500">
              <div className="text-sm font-bold text-blue-600 mb-2">📝 השאלה:</div>
              <p className="text-[#030202] text-base leading-relaxed whitespace-pre-wrap">
