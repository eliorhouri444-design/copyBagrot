      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <motion.div
          ...
          <div className="mx-1 my-2 pt-6 pr-1 pb-1 pl-1 py-1 space-y-3">
            ...
            <Button
              onClick={goToNextSet}
              className="w-full h-12 bg-[#2086b1] hover:bg-[#1a6d91] text-lg font-bold rounded-2xl">
          ...
          <motion.div
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                    ...
                    {userAnswer && (
                      <Button
                        ...
                        className="w-full h-14 bg-[#2086b1] hover:bg-[#1a6d91] text-lg font-bold rounded-2xl mt-4"
                      >
                        אשר תשובה
                      </Button>
                    )}
              ...
              <div className="space-y-4">
                  ...
                  className="w-full h-14 bg-[#2086b1] hover:bg-[#1a6d91] text-lg font-bold rounded-2xl">
