            ...
            <div className="p-5 text-center">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  className={`w-full ${user?.is_premium ? 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700' : 'bg-gray-400 hover:bg-gray-500'} text-white h-12 text-sm font-bold flex items-center justify-center gap-2 shadow-lg`}
                >
                  {user?.is_premium ? (
                    <>
            ...
            <div className="p-5 text-center">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  className={`w-full ${user?.is_premium ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700' : 'bg-gray-400 hover:bg-gray-500'} text-white h-12 text-sm font-bold flex items-center justify-center gap-2 shadow-lg`}
                >
                  {user?.is_premium ? (
                    <>
                      <Target className="w-5 h-5" />
