...
import { 
  BookOpen, ChevronLeft, Loader2, Check, Zap, PlayCircle, List
} from 'lucide-react';
...
export default function GrammarTopicsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Load all grammar questions count
  ...
  const handleStartPractice = () => {
    navigate(createPageUrl("GrammarPracticeNew?mode=auto"));
  };

  const handleStrengthenWeak = () => {
    navigate(createPageUrl("GrammarPracticeNew?mode=weak"));
  };
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <div className="bg-blue-600 px-5 py-4 rounded-b-2xl mb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center flex-1">
            <h1 className="text-lg font-bold text-white">דקדוק • Grammar</h1>
          </div>
      ...
      <div className="px-5 space-y-6">
        {/* Stats Cards - Same style as Vocabulary */}
        ...
        <div className="text-center pt-4">
          <button
            onClick={() => navigate(createPageUrl("GrammarTopicsSelection"))}
            className="text-gray-500 hover:text-blue-600 font-medium flex items-center justify-center gap-2 mx-auto transition-colors"
          >
