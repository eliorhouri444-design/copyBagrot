...
export default function MasteryStatsCard({ mastery, type = "topic" }) {
  ...
  const getScoreBg = (score) => {
    if (score >= 80) return "bg-green-50 border-blue-500";
    if (score >= 60) return "bg-blue-50 border-blue-500";
    if (score >= 40) return "bg-orange-50 border-blue-500";
    return "bg-red-50 border-blue-500";
  };
    ...
    <div className="bg-white rounded-xl p-3 space-y-2.5">
      ...
      <>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <div className="bg-blue-50 rounded-lg p-2 text-center border border-blue-500">
            ...
            <div className="bg-purple-50 rounded-lg p-2 text-center border border-blue-500">
        ...
        <div className="bg-red-50 rounded-lg p-2 border border-blue-500">
      ...
      <>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <div className="bg-amber-50 rounded-lg p-2 text-center border border-blue-500">
              <div className="text-[14px] font-bold text-amber-600">{mastery.bestScore}</div>
              <div className="text-[9px] text-gray-600">הכי גבוה</div>
            </div>
            <div className="bg-cyan-50 rounded-lg p-2 text-center border border-blue-500">
