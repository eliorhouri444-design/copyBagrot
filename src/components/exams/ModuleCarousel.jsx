              ...
              <>
                ...
                <>
                  ...
                  <Button
                    ...
                    variant="outline" className="bg-[#ffffff] text-blue-500 px-4 py-2 font-semibold rounded-[14px] inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm w-full h-10 border-2 border-blue-500 hover:bg-white hover:text-blue-500">
